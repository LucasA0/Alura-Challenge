...
var btnAdd = document.getElementById('crypto').addEventListener('click', function(event){
    ...
    var input = remover_acentos_espaco(document.getElementById('first').value.toLowerCase());
    ...
    document.getElementById('first').value = '';// em seguida ele recebe um valor nulo
